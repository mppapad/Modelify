        ...
        <div className="pt-8">
            <div className="relative mx-auto flex max-w-2xl flex-col items-center">
                  ...
                  <span className="relative inline-block overflow-hidden rounded-full p-[1px]">
                    ...
                    <div
                        className="inline-flex h-full w-full justify-center rounded-full bg-white px-3 py-1 text-xs font-medium leading-5 text-slate-600 backdrop-blur-xl dark:bg-black dark:text-slate-200">
                     Introducing Modelify
                      ...
                      <h2 className="text-center text-4xl font-medium text-gray-900 dark:text-gray-50 sm:text-6xl">
                          Watch your products,{' '}
                          <span
                              className="animate-text-gradient inline-flex bg-gradient-to-r from-neutral-900 via-indigo-600 to-neutral-500 bg-[200%_auto] bg-clip-text leading-tight text-transparent dark:from-neutral-100 dark:via-slate-400 dark:to-neutral-400">
                  come to life
                </span>
                      </h2>
                      <p className="mt-6 text-center text-md leading-6 text-gray-600 dark:text-gray-200">
                          Effortlessly showcase and interact with your 3D models, directly in your
                      ...
                      <Button asChild className="m-10 bg-indigo-600 hover:bg-indigo-400">
                          ...
                          <Link href="/model"> <span className="text-xl font-normal text-gray-800">  <Eye size={28} color="#ffffff" strokeWidth={2} /></span>Live Demo</Link>
                      </Button>
                  </div>
              </div>
          </div>
